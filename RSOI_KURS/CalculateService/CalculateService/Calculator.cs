    ...
    public class Calculator
    {
        ...
        static void Worker(string[] args)
        {
            ...
            while (GiantSteps > 0)
            {
                ...
                {
                    int errorCount = 0;
                    while (Benefits(first) >= Benefits(current) || Cost(current) >= OurMoneys)
                    {
                        float GC = -1;
                        while (GC < 0)
                        {
            ...
            while (limitSteps > 0)
            {
                ...
                if (Benefits(Extented) > Benefits(worst) && Cost(Extented) <= OurMoneys && PointIsPositive(Extented))
                {
                ...
                if (Benefits(Reflected) > Benefits(worst) && Cost(Reflected) <= OurMoneys && PointIsPositive(Reflected))
                {
                    if (worstIdentifier == 1)
                    {
                        p1 = Reflected;
                ...
                if (Benefits(Compression) > Benefits(worst) && Cost(Compression) <= OurMoneys && PointIsPositive(Compression))
                {
                    if (worstIdentifier == 1)
                    {
                        p1 = Compression;
                ...
                if (Benefits(Random) > Benefits(worst) && Cost(Random) <= OurMoneys && PointIsPositive(Random))
                {
                    if (worstIdentifier == 1)
                    {
                        p1 = Random;
